...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            if(state === 'Sign Up'){
                const {data} = await axios.post(backendUrl + 'api/auth/register', {name,email,password});  // Fix: gunakan 'url' bukan 'backendUrl'
                ...
                const {data} = await axios.post(backendUrl + 'api/auth/login', {email,password});  // Fix: gunakan 'url' bukan 'backendUrl'
